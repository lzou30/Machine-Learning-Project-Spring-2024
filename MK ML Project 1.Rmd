...
group2.0 <- group1.9 %>%
  select(-c(State, ZIP.code, Company.public.response, Consumer.disputed., pct_young, SoslhwsldidA, old_service_mem, medical_debt, Consumer.complaint.narrative, Complaint.ID, Product, COUNTYNAME, STCOUNTYFP, AGEGRP, Company, Date.sent.to.company))
...
group2.1 <- group2.0[, -c(1:3, 13:89, 100:101)]
