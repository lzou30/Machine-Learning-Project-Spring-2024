...
# Load packages
pacman::p_load(tidyverse, ggplot2, scales, glmnet, pls, randomForest, rpart, DescTools, readxl, corrplot, ggcorrplot, factoextra, ggfortify, clustMixType, wesanderson, caret, rpart.plot, xgboost, reshape2, MLmetrics, SHAPforxgboost, ROSE, ineq, catboost)
...
# Add with five clusters (based on scree plot)
...
lm.accuracy <- (7319 + 3726)/(7319 + 3726 + 2700 + 6248) # 0.5524434
lm.F1 <- F1_Score(lm.predict, default_tst$relief) # 0.6206224
...
rf.accuracy <- (8370 + 9687)/(8370 + 9687 + 1649 + 287) # 0.9031661
rf.F1 <- F1_Score(rf.predict, default_tst$relief) # 0.8963375
...
for(i in 1:length(gamma)){ 
  params = list(eta = 0.2, colsample_bylevel=1, 
...
# xgb.plot.tree(model = xgb2, trees = 1)
