...
##### WHAT CENSUS VARS DO WE WANT TO KEEP
# Keep the percentage of non-Hispanic white Americans
group2.0$pct_non_hisp_white <- (group2.0$NHWA_FEMALE_MEAN + group2.0$NHWA_MALE_MEAN)/group2.0$TOT_POP_MEAN

# Drop most of the Census variables, date received (because we have the year now)
group2.1 <- group2.0[, -c(3, 14:90, 100:101)]
...
set.seed(182654)
x <- model.matrix(group2.1$relief ~ ., group2.1[,-c(1:2)])
y <- group2.1$relief
...
mse.lasso <- mean((lasso.pred - y.test)^2) # 0.116155
